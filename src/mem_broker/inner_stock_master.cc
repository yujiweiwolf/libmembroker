...
void InnerStockMaster::InitPositions(MemGetTradePositionMessage* rep) {
...
int64_t InnerStockMaster::GetAutoOcFlag(int64_t bs_flag, const MemTradeOrder& order) {
